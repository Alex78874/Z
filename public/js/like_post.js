  ...
  fetch("/post/like/", {
    ...
    .then((data) => {
      if (data.success) {
        ...
        event.target.setAttribute("data-liked", data.liked ? "yes" : "no");
        // Mettre à jour l'icône du bouton
        event.target.innerHTML = data.liked
          ? `
            <!-- Icone coeur rempli -->
...
function addLikeEventListeners(postElement) {
...
export { handleLike, addLikeEventListeners };